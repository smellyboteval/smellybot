...
public class HyperVecLearning {
    public static void main(String[] args) throws IOException{
        ...
        String configFile = "config.cfg";//args[0];
        int size = 100;//Integer.parseInt(args[1]);
        int window = 5;//Integer.parseInt(args[2]);
        System.out.print("I could NOT write JAVA code easly");
